      ...
      <div className="flex items-center gap-3">
        <div className="relative max-w-md flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-neutral-800 bg-neutral-950/80 py-2 pr-4 pl-10 text-sm text-neutral-50 placeholder-neutral-500 focus:border-neutral-700 focus:ring-1 focus:ring-neutral-700 focus:outline-none"
          />
        </div>
        <button
      ...
      <div className="overflow-hidden rounded-xl border border-neutral-800/80 bg-neutral-900/60">
        <table className="w-full" aria-label="Users management table">
          <caption className="sr-only">
            List of platform users with their email, roles, status, and creation date. Click on a
            user row to view details.
          </caption>
          <thead>
              ...
              users.map((user) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    ...
                    {user.emailVerified && <span className="text-xs text-green-400">Verified</span>}
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3">
                    {user.isDeactivated ? (
                      ...
                      <span className="inline-flex items-center rounded-md border border-green-500/30 bg-green-500/20 px-2 py-0.5 text-xs font-medium text-green-300">
                        Active
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-3 text-right">
                    ...
                    <button
                      ...
                      className="rounded p-1 text-neutral-500 opacity-0 transition group-hover:opacity-100 hover:bg-neutral-700 hover:text-neutral-300"
                    >
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-neutral-500">
            ...
            {Math.min(state.page * state.pageSize, total)} of {total} users
          </div>
