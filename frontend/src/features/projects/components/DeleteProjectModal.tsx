...
export function DeleteProjectModal({
  ...
  return (
    <ConfirmationDialog
      ...
      title={modalTitle}
      description={isDeletionComplete ? "Project successfully deleted" : modalDescription}
      confirmText={isDeletionComplete ? "Close" : (isLoading ? "Deleting..." : "Confirm Delete")}
      cancelText={isDeletionComplete ? undefined : "Cancel"}
      onConfirm={isDeletionComplete ? handleClose : handleConfirm}
      onCancel={isDeletionComplete ? undefined : handleClose}
      variant={isDeletionComplete ? "info" : "destructive"}
      isLoading={isLoading}
      confirmDisabled={isDeletionComplete ? false : isConfirmDisabled}
      size="md"
    >
