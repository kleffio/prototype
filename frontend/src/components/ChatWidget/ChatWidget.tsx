    ...
    <div className="fixed right-6 bottom-6 z-50 flex flex-col items-end">
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Input Area - WCAG 2.0 AA: Form with proper labels */}
          <div className="bg-background border-border border-t p-4">
            ...
            >
              {/* WCAG 2.0 AA: Input has accessible label */}
              ...
              />
              {/* WCAG 2.0 AA: Submit button has accessible name */}
              <button
                type="submit"
      ...
      {/* Toggle Button - WCAG 2.0 AA: Button has accessible name */}
      {!isOpen && (
        <button
          ...
          aria-label="Open Kleff Assistant chat"
          title="Open chat"
        >
