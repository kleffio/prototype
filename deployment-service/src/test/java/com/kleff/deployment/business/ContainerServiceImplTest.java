...
class ContainerServiceImplTest {
        ...
        void whenGetAllContainers_thenReturnList() {
                ...
                ContainerResponseModel response = ContainerResponseModel.builder().containerID("uuid-1")
                                .name("test-app")
                                .build();
        ...
        void whenCreateContainer_thenSaveAndTriggerBuild() throws JsonProcessingException {
                ...
                // Act
                ContainerResponseModel actualResponse = containerService.createContainer(request, "test-user");
        ...
        void whenGetContainerException_thenReturnNull() {
                // Arrange
                when(containerRepository.findContainerByContainerID(anyString()))
        ...
        void whenExternalBuildFails_thenStillReturnSavedContainer() {
                ...
                // We need to ensure the DB transaction isn't rolled back and the user still
                // gets a response.
                ...
                mockServer
                                .expect(ExpectedCount.once(), requestTo(
                                                "http://deployment-backend-service.kleff-deployment.svc.cluster.local/api/v1/build/create"))
                                .andRespond(withStatus(HttpStatus.INTERNAL_SERVER_ERROR));

                // Act
                ContainerResponseModel result = containerService.createContainer(request, "test-user");
        ...
        void whenWebAppUpdateFails_thenStillReturnResponse() {
                ...
                mockServer
                                .expect(ExpectedCount.once(), requestTo(
                                                "http://deployment-backend-service.kleff-deployment.svc.cluster.local/api/v1/webapp/update"))
                                .andRespond(withStatus(HttpStatus.INTERNAL_SERVER_ERROR));

                // Act
                ContainerResponseModel result = containerService.updateContainerEnvVariables(id, env, "test-user");

                // Assert
                assertThat(result).isNotNull();
                mockServer.verify();
                // Logic check: The catch block in triggerWebAppUpdate prevents the whole method
                // from failing
        ...
        void whenToResponseModel_thenDelegateToMapper() {
                ...
                ContainerResponseModel expectedResponse = ContainerResponseModel.builder().containerID("test-id")
                                .build();
        ...
        void whenUpdateContainer_thenSaveAndTriggerBuild() throws JsonProcessingException {
                ...
                ContainerResponseModel response = ContainerResponseModel.builder().containerID(id).name("updated-name")
                                .build();
                ...
                // Act
                ContainerResponseModel result = containerService.updateContainer(id, request, "test-user");
        ...
        void whenUpdateContainerNotFound_thenThrowException() {
                ...
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.updateContainer("none", request, "test-user");
                });
        ...
        void whenDeleteContainerWithConstraintViolation_thenThrowException() {
                ...
                // Act & Assert
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.deleteContainer(containerID, "test-user");
                });
        ...
        void whenCreateContainerDatabaseSaveFails_thenThrowException() {
                ...
                // Act & Assert
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.createContainer(request, "test-user");
                });
        ...
        void whenUpdateContainerEnvVariablesDatabaseSaveFails_thenThrowException() {
                ...
                Container existingContainer = Container.builder().containerID(containerID).projectID("p1").name("n1")
                                .build();
                ...
                // Act & Assert
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.updateContainerEnvVariables(containerID, envVariables, "test-user");
                });
        ...
        void whenUpdateContainerWithEmptyEnvVariables_thenHandleCorrectly() {
                ...
                ContainerResponseModel response = ContainerResponseModel.builder().containerID(containerID)
                                .name("test-app")
                                .build();
                ...
                // Act
                ContainerResponseModel result = containerService.updateContainer(containerID, request, "test-user");
        ...
        void whenCreateContainerWithNullOrEmptyBranch_thenUseDefaultBranch() {
                ...
                // Act
                containerService.createContainer(requestWithNullBranch, "test-user");
                ...
                // Act
                containerService.createContainer(requestWithEmptyBranch, "test-user");
        ...
        void whenDeleteContainerSuccess_thenDeleteFromDatabaseAndTriggerWebAppDeletion() {
                ...
                mockServer.expect(ExpectedCount.once(),
                                requestTo(
                                                "http://deployment-backend-service.kleff-deployment.svc.cluster.local/api/v1/webapp/p1/c-123"))
        ...
        void whenDeleteContainerWithNullContainerID_thenThrowException() {
                // Act & Assert
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.deleteContainer(null, "test-user");
                });
        ...
        void whenDeleteContainerWithEmptyContainerID_thenThrowException() {
                // Act & Assert
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () -> {
                        containerService.deleteContainer("", "test-user");
                });
        ...
        void whenTriggerWebAppDeletionSuccess_thenDeleteWebApp() {
                ...
                // Act
                containerService.deleteContainer(containerID, "test-user"); // This will call triggerWebAppDeletion
                                                                            // internally
        ...
        void whenDeleteContainerWithMalformedProjectID_thenHandleGracefully() {
                ...
                mockServer.expect(ExpectedCount.once(),
                                requestTo(
                                                "http://deployment-backend-service.kleff-deployment.svc.cluster.local/api/v1/webapp/p1/with/slashes/c-123"))
                                .andRespond(withSuccess("WebApp deleted", MediaType.TEXT_PLAIN));
        ...
        void whenDeleteContainerWithVeryLongContainerID_thenHandleGracefully() {
                ...
                mockServer.expect(ExpectedCount.once(),
                                requestTo(
                                                "http://deployment-backend-service.kleff-deployment.svc.cluster.local/api/v1/webapp/p1/very-long-container-id-that-might-cause-issues-with-url-length-or-database-constraints-1234567890"))
                                .andRespond(withSuccess("WebApp deleted", MediaType.TEXT_PLAIN));
